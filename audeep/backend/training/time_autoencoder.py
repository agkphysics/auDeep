...
class TimeAutoencoderWrapper(BaseFeatureLearningWrapper):
    """
    Implementation of the `BaseFeatureLearningWrapper` interface for time-autoencoders.
    """
    ...
    def _create_model(self,
        ...
        with tf.variable_scope("model"):
            TimeAutoencoder(encoder_architecture=kwargs["encoder_architecture"],
                            decoder_architecture=kwargs["decoder_architecture"],
                            mask_silence=kwargs["mask_silence"],
                            inputs=tf_inputs,
